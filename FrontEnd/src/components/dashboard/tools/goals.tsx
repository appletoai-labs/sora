...
const Goals: React.FC = () => {
    ...
    const predefinedGoalTypes = {
        'Daily Check-in': {
            ...
            description:
                "Track your daily mood, energy, and wellness through SORA's check-in system",
        ...
        'Task Breakdown': {
            ...
            description:
                "Use SORA's clarity tools to break down an overwhelming task into manageable steps",
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                    {goals
                        ...
                        .map((goal) => (
                            <Card
                                key={goal._id}
                                className="bg-gradient-to-br from-sora-card to-sora-muted border-sora-teal/20"
                            >
                            ...
                            >
                                <CardContent className="p-6">
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        {isUnlocked && (
                                            <Badge className="bg-sora-teal text-sora-dark">
                                                Unlocked
                                            </Badge>
                                        )}
                                    </div>
