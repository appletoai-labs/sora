...
const DailyCheckin: React.FC = () => {
  ...
  const RatingScale = ({
    ...
    <div className="flex flex-col items-center space-y-4">
      ...
      {value && <div className="text-center text-gray-300 mt-4 max-w-xs">{descriptions[value - 1]}</div>}
    </div>
  )
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Take a moment to reflect on how you're feeling today. This helps build self-awareness and track patterns
            over time.
          </p>
        </div>
        ...
        <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 mb-8">
          <CardHeader>
            <CardTitle className="text-2xl text-cyan-400 text-center">How are you feeling today?</CardTitle>
            <p className="text-gray-400 text-center">
              Rate each area from 1 (very low/difficult) to 10 (very high/easy). There are no right or wrong answers -
          ...
          <CardContent className="space-y-12">
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-h-64 overflow-y-auto">
                {moodDescriptions.map((desc, index) => (
                  <div
                    key={index}
                    className={cn(
                      "text-gray-300 text-sm py-1 border-b border-gray-700 last:border-b-0",
                      checkinData.mood === index + 1 && "bg-cyan-900/50 font-bold text-white rounded-md px-2",
                    )}
                  >
                    <span className="text-cyan-400 font-medium">{index + 1}:</span> {desc}
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center">
                <div className="flex items-center justify-center mb-4">
                  <div className="text-4xl mr-3">😰</div>
                  <div>
                    <h3 className="text-xl font-semibold text-white">Anxiety Level</h3>
                    <p className="text-gray-400">How anxious or worried are you feeling?</p>
                  </div>
                </div>
                <RatingScale
                  value={checkinData.anxiety}
                  onChange={(value) => setCheckinData({ ...checkinData, anxiety: value })}
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-h-64 overflow-y-auto">
                {anxietyDescriptions.map((desc, index) => (
                  <div
                    ...
                    className={cn(
                      "text-gray-300 text-sm py-1 border-b border-gray-700 last:border-b-0",
                      checkinData.anxiety === index + 1 && "bg-cyan-900/50 font-bold text-white rounded-md px-2",
                    )}
                  >
                    <span className="text-cyan-400 font-medium">{index + 1}:</span> {desc}
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white">Sensory Sensitivity</h3>
                    <p className="text-gray-400">How overwhelming do sounds, lights, textures, or crowds feel?</p>
                  </div>
                </div>
                <RatingScale
                  value={checkinData.sensory}
                  onChange={(value) => setCheckinData({ ...checkinData, sensory: value })}
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-h-64 overflow-y-auto">
                {sensoryDescriptions.map((desc, index) => (
                  <div
                    ...
                    className={cn(
                      "text-gray-300 text-sm py-1 border-b border-gray-700 last:border-b-0",
                      checkinData.sensory === index + 1 && "bg-cyan-900/50 font-bold text-white rounded-md px-2",
                    )}
                  >
                    <span className="text-cyan-400 font-medium">{index + 1}:</span> {desc}
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-center">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white">Executive Function</h3>
                    <p className="text-gray-400">How easy is it to focus, organize, and complete tasks?</p>
                  </div>
                </div>
                <RatingScale
                  value={checkinData.executive}
                  onChange={(value) => setCheckinData({ ...checkinData, executive: value })}
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-h-64 overflow-y-auto">
                {executiveDescriptions.map((desc, index) => (
                  <div
                    ...
                    className={cn(
                      "text-gray-300 text-sm py-1 border-b border-gray-700 last:border-b-0",
                      checkinData.executive === index + 1 && "bg-cyan-900/50 font-bold text-white rounded-md px-2",
                    )}
                  >
                    <span className="text-cyan-400 font-medium">{index + 1}:</span> {desc}
                  </div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">How much energy do you have for activities?</p>
                  </div>
                </div>
                <RatingScale
                  value={checkinData.energy}
                  onChange={(value) => setCheckinData({ ...checkinData, energy: value })}
              ...
              <div className="bg-gray-800 rounded-lg p-4 max-h-64 overflow-y-auto">
                {energyDescriptions.map((desc, index) => (
                  <div
                    ...
                    className={cn(
                      "text-gray-300 text-sm py-1 border-b border-gray-700 last:border-b-0",
                      checkinData.energy === index + 1 && "bg-cyan-900/50 font-bold text-white rounded-md px-2",
                    )}
                  >
                    <span className="text-cyan-400 font-medium">{index + 1}:</span> {desc}
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <h3 className="text-xl font-semibold text-white">Additional Notes (Optional)</h3>
              </div>
              <p className="text-gray-400">
                Share anything specific about today - what went well, what was challenging, or anything else on your
                mind.
              </p>
              <Textarea
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4 bg-gray-800 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Same Time Daily</h3>
                <p className="text-gray-300 text-sm">
                  Try to check in at the same time each day to build a helpful routine.
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-gray-800 rounded-lg">
                ...
                <p className="text-gray-300 text-sm">
                  There's no judgment here. Honest ratings help you understand your patterns.
                </p>
              </div>

              <div className="text-center p-4 bg-gray-800 rounded-lg">
                <TrendingUp className="w-12 h-12 text-cyan-400 mx-auto mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Look for Patterns</h3>
                <p className="text-gray-300 text-sm">
                  Over time, you'll start to see patterns that can guide your self-care.
                </p>
              </div>

              <div className="text-center p-4 bg-gray-800 rounded-lg">
                <Star className="w-12 h-12 text-cyan-400 mx-auto mb-3" />
                <h3 className="text-lg font-semibold text-white mb-2">Celebrate Progress</h3>
                <p className="text-gray-300 text-sm">
                  Notice improvements, even small ones. Every step forward matters.
                </p>
              </div>
            </div>
          </CardContent>
